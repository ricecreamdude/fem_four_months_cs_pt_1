...
Very easy and very fast to search for

Search is made by comparison rather than order

Looks like it uses a "more than less than" type of organization

Goal is to flatten data strutcture

Important to have your data somewhat unorganized.

NOT REALLY USED in production, mostly used for conceptual
...
//
//   add(value) {
//     if (_compare(this.branch.value, value)) {
//       if (this.left) {
//         this.left.add(value)
//       } else {
...
//   }
//
//   //Compares if A is larger than B
//   _compare(a, b) {
//     if (a > b) return true
//     return false
//   }
